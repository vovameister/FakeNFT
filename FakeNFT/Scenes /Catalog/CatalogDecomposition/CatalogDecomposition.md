...
- Таблица с NFT на экране каталога (план: 2 часа, факт: )
- Кнопка сортировки (план: 30 минут, факт: )
- Action sheets для обработки нажатия на кнопку сортировки (план: 30 минут, факт: )
- Индикатор загрузки NFT (план: 30 минут, факт: )

##### Логика:
- Загрузка изображения NFT (план: 3 часа, факт: )
- Получение названия / кол-ва NFT (план: 1,5 часа, факт: )

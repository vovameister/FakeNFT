...
final class ProfileService2: PropfileServiceProtocol, EditProfileServiceProtocol {
    static let shared = ProfileService2(networkClient: DefaultNetworkClient(), storage: ProfileStorage.shared)
